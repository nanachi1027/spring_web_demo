...
class FocusTrapDirective {
    ...
    createFocusableOffScreenEl() {
        ...
        const /** @type {?} */ offScreenSpan = this.document.createElement("span");
 ...
 * The full license information can be found in LICENSE in the root directory of this project.
 */
const ɵ0 = FocusTrapTrackerProvider;
...
/** @nocollapse */
DateFormControlService.ctorParameters = () => [];
        ...
        this.subscriptions.push(this._items.allChanges.subscribe(updatedItems => {
            switch (this.selectionType) {
                ...
                case SelectionType.Single: {
                    ...
                    // if the currentSingle has been set before data was loaded, we look up and save the ref from
                    // current data set
                ...
                case SelectionType.Multi: {
                    ...
                    const /** @type {?} */ trackBy = this._items.trackBy;
                    let /** @type {?} */ selectionUpdated = false;
                    // if the current has been set before data was loaded, we look up and save the ref from current data
                    // set
 ...
 * The full license information can be found in LICENSE in the root directory of this project.
 */
const ɵ0$1 = clrTreeSelectionProviderFactory;
...
const ɵ0$2 = ResponsiveNavigationProvider;
